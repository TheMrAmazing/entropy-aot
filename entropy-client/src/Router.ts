...
import Live from './views/Channel/Live'
import Settings from './views/Channel/Settings'
import Widgets from './views/Channel/Widgets'
...
export class Router extends Component {
	...
	constructor(routes: typeof Routes) {
		super()
		this.routes = routes
