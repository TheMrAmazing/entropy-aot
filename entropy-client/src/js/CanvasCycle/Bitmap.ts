...
export class Bitmap {
	...
	palette: Palette
	drawCount: number = 0
	optPixels: Array<number>
	optColors: Array<number>
	
	constructor(img: ImgType) {
		// class constructor
		this.optColors = []
		this.optPixels = []
	...
	optimize() {
		...
		var optPixels = this.optPixels = new Array<number>()
	...
	render(imageData: ImageData, optimize: boolean) {
