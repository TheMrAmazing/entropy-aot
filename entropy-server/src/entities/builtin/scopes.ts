...
type PropertyPermissions = GET.User | GET.GlobalRole | GET.Domain | GET.Developer | GET.DevItem | GET.StoreItem | GET.Channel | GET.Widget | GET.Room | GET.Message | GET.DomainRole | PUT.User | PUT.GlobalRole | PUT.Domain | PUT.Developer | PUT.DevItem | PUT.StoreItem | PUT.Channel | PUT.Widget | PUT.Room | PUT.Message | PUT.DomainRole
type RelationPermissions = POST.User | POST.GlobalRole | POST.Domain | POST.Developer | POST.DevItem | POST.StoreItem | POST.Channel | POST.Widget | POST.Room | POST.Message | POST.DomainRole | DELETE.User | DELETE.GlobalRole | DELETE.Domain | DELETE.Developer | DELETE.DevItem | DELETE.StoreItem | DELETE.Channel | DELETE.Widget | DELETE.Room | DELETE.Message | DELETE.DomainRole
